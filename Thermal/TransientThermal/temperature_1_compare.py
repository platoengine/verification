...
def sol(x):
  ...
  # Looking at t = 100 sec
  return 100*math.sin(3.14159*2*x/L)*math.exp(-l * 250)
...
# time step (looking at 25th time step or t = 250 sec)
variable = {'name': 'Temperature', 'time': 25.0}
