...
def sol(x):
  ...
  # Looking at t = 750 sec
  return 100*math.sin(3.14159*2*x/L)*math.exp(-l * 750)
...
# time step (looking at 75th time step or t = 750 sec)
variable = {'name': 'Temperature', 'time': 75.0}
