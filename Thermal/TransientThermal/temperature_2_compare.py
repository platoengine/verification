...
def sol(x):
  ...
  # Looking at t = 200 sec
  return 100*math.sin(3.14159*2*x/L)*math.exp(-l * 500)
...
# time step (looking at 50th time step or t = 500 sec)
variable = {'name': 'Temperature', 'time': 50.0}
